...
source: github-auto
summary: >-
  This repository contains SAS scripts for analyzing experimental design data,
  focusing on statistical modeling and analysis of treatment effects. It
  includes projects that demonstrate the use of generalized linear models and
...
2. Open SAS and load either `FInalProject.sas` or `MidtermProject.sas`.

3. Run the scripts to perform the analyses. Output files (PDF reports) will be generated at specified paths in the scripts (adjust paths as needed).
